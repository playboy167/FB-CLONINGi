...
╚═╝     ╚═════╝                                              
 ...
 ██████╗██╗      ██████╗ ███╗   ██╗██╗███╗   ██╗ ██████╗  \x1b[91;1m𝑇𝐻𝐼𝑆 𝑇𝑂𝑂𝐿 𝐶𝑂𝐷𝐼𝑁𝐼𝐺 𝐵𝑌 (𝐷𝑋-𝑃𝐿𝐴𝑌😎)
██╔════╝██║     ██╔═══██╗████╗  ██║██║████╗  ██║██╔════╝     
██║     ██║     ██║   ██║██╔██╗ ██║██║██╔██╗ ██║██║  ███╗    
██║     ██║     ██║   ██║██║╚██╗██║██║██║╚██╗██║██║   ██║    
╚██████╗███████╗╚██████╔╝██║ ╚████║██║██║ ╚████║╚██████╔╝    
 ╚═════╝╚══════╝ ╚═════╝ ╚═╝  ╚═══╝╚═╝╚═╝  ╚═══╝ ╚═════╝     
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m ☢︎︎𝘼𝙐𝙏𝙃𝙊𝙍       \x1b[92;1m=>      \x1b[93;1m 😈𝐷𝑋-𝑃𝐿𝐴𝑌 𝐵𝑂𝑌 😈
\x1b[93;1m ☢︎︎𝙒𝙃𝘼𝙏𝙎𝘼𝙋   \x1b[92;1m=>      \x1b[93;1m+8801979526394
\x1b[93;1m ☢︎︎𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆       \x1b[92;1m=>      \x1b[93;1mレイハンプレイボーイ
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	print("""%s \33[1;33m[1] 𝙁𝙞𝙡𝙚 𝘾𝙧𝙖𝙘𝙠  """%(h))
	print("""%s \33[1;33m[0] 𝙀𝙭𝙞𝙩"""%(h))
	print("""%s \x1b[92;1m===================================>\x1b[92;1m """%(h))
	...
	if farhan in ['1','01']:
		...
		os.system("https://www.facebook.com/profile.php?id=100072883587040")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [🔥P҉L҉A҉Y҉ B҉O҉Y҉🔥] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
